...
(1, 'employee11',   'password1234', 'Employee'),
(2, 'employee2',    CAST('$2b$12$EYJqR7xEfcRuvEUp3icsHOtM5oxIzpmniWmSKjnUqFI4QNjOtnFQi' AS BLOB), 'Employee'),
(3, 'postman1',     CAST('$2b$12$n.gg34RDVkUlfAkWhkzjn.zc1RDKkAGvLjGZ9Gr1OkYCc0NlTu0Cy' AS BLOB), 'Employee'),
(4, 'test_manager', '$2a$12$sZZ3GAWLOSpU9zIdSX.pZ.QUmuHvizurrTvpjSkvTALywz6oZf4YK', 'Manager');
...
(14,  62.75, 'Team lunch with client',      '2026-06-04', 2, 'Meals'),
(15, 129.99, 'Mechanical keyboard',         '2026-06-10', 2, 'Office Supplies'),
(16, 199.00, 'IntelliJ license renewal',    '2026-06-15', 3, 'Software'),
(17, 350.00, 'SQL certification course',    '2026-06-20', 3, 'Training'),
(18,  45.30, 'Rideshare to airport',        '2026-06-28', 1, 'Other'),
(19,  88.20, 'Client dinner',               '2026-07-01', 2, 'Other'),
...
(23,  54.20, 'Working lunch, new hires',    '2026-05-12', 2, 'Meals'),
(24,  89.99, 'Standing desk mat',           '2026-05-18', 2, 'Office Supplies'),
(25, 149.00, 'GitHub Copilot annual',       '2026-05-20', 3, 'Software'),
(26, 499.00, 'AWS certification exam',      '2026-06-08', 3, 'Training'),
(27,  23.80, 'Client coffee meeting',       '2026-06-11', 2, 'Meals'),
(28, 180.75, 'Train tickets, client site',  '2026-06-17', 1, 'Travel'),
(29,  65.00, 'Whiteboard and markers',      '2026-07-02', 3, 'Office Supplies'),
(30, 120.00, 'Team dinner, project launch', '2026-07-03', 2, 'Meals'),
(31, 240.00, 'Online course subscription',  '2026-07-05', 3, 'Training'),
(32,  74.99, 'Ergonomic mouse',             '2026-07-06', 1, 'Office Supplies'),
(33, 415.00, 'Flight to team offsite',      '2026-07-08', 2, 'Travel'),
(34,  29.50, 'Lunch with vendor',           '2026-07-10', 3, 'Meals'),
(35, 189.00, 'Docker Desktop licenses',     '2026-07-12', 2, 'Software');
...
(12, 'approved', 4, 'Standard client travel',         '2026-06-05'),
(13, 'approved', 4, 'Within lodging policy',          '2026-06-05'),
(14, 'approved', 4, 'Client meal, receipt attached',  '2026-06-06'),
(15, 'denied',   4, 'Personal equipment not covered', '2026-06-12'),
(16, 'approved', 4, 'Annual license, budgeted',       '2026-06-16'),
(17, 'pending',  NULL, NULL, NULL),
(18, 'pending',  NULL, NULL, NULL),
(19, 'pending',  NULL, NULL, NULL),
(20, 'approved', 4, 'Quarterly review travel',        '2026-05-08'),
(21, 'approved', 4, 'Within lodging policy',          '2026-05-08'),
(22, 'denied',   4, 'Use rideshare next time',        '2026-05-09'),
(23, 'approved', 4, 'Onboarding meal',                '2026-05-13'),
(24, 'denied',   4, 'Home office gear not covered',   '2026-05-19'),
(25, 'approved', 4, 'Approved team tooling',          '2026-05-21'),
(26, 'approved', 4, 'Cert supports current project',  '2026-06-09'),
(27, 'approved', 4, 'Client relations',               '2026-06-12'),
